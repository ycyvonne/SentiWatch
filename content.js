...
sheet.innerHTML = "div#subclass_id {border: 2px solid black; width: 200px;height: 100px;margin-left:90%; background-color: yellow; box-shadow: 10px 10px 5px grey;}";
document.body.appendChild(sheet);
var toAppend = '<div class="main_class" id="id_class"><div class="subclass" id="subclass_id">Your Language is a little abusive, you should consider rephrasing your sentence!<div></div>';
